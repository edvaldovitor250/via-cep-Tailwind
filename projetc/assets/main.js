function exibirResultado(cepData) {
    ...
    if (cepData.erro) {
        ...
        const bandeiras = {
            'AC': './projetc/assets/img/acre.png', 
            'AL': './projetc/assets/img/alagoas.png',
            'AM': './projetc/assets/img/amazonas.png',
            'AP': './projetc/assets/img/amapa.png',
            'BA': './projetc/assets/img/bahia.png',
            'CE': './projetc/assets/img/ceara.png',
            'DF': './projetc/assets/img/distrito-federal.png',
            'ES': './projetc/assets/img/espirito-santo.png',
            'GO': './projetc/assets/img/goias.png',
            'MA': './projetc/assets/img/maranhao.png',
            'MG': './projetc/assets/img/minas-gerais.png',
            'MS': './projetc/assets/img/mato-gross.png',
            'MT': './projetc/assets/img/mato-grosso.png',
            'PA': './projetc/assets/img/para.png',
            'PB': './projetc/assets/img/paraiba.png',
            'PE': './projetc/assets/img/pernambuco.png',
            'PI': './projetc/assets/img/piaui.png',
            'PR': './projetc/assets/img/parana.png',
            'RJ': './projetc/assets/img/rio-de-janeiro.png',
            'RN': './projetc/assets/img/rio-grande-norte.png',
            'RO': './projetc/assets/img/rondonia.png',
            'RR': './projetc/assets/img/roraima.png',
            'RS': './projetc/assets/img/rio-grande-do-sul.png',
            'SC': './projetc/assets/img/santa-catarina.png',
            'SE': './projetc/assets/img/sergipe.png',
            'SP': './projetc/assets/img/sao-paulo.png',
            'TO': './projetc/assets/img/tocantins.png',
          };
